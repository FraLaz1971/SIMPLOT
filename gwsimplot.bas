...
350     NEXT J
360 NEXT I
410 READ XMINP: READ XMAXP: READ XTIK 
420 READ YMINP: READ YMAXP: READ YTIK
500 REM XAXT$ = "n.": YAXT$ = "X^2"
500 READ XAXT$ : READ YAXT$
...
20170 FOR ZI = 0 TO ZDX: LOCATE ZT3 + 1, ZT0 + INT(ZI * ZTX / (ZDX+1) + .5)
...
20500 REM DATA 11
20510 REM DATA 1,1,2,4,3,9,4,16,5,25,6,36,7,49,8,64,9,81,10,100
20520 REM DATA 11,121
20610 REM DATA 1,11,1
20620 REM DATA 1,130,1
20630 REM DATA "N"
20640 REM DATA "F(N)"
